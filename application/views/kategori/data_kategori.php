                ...
                <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    <table class="display table table-bordered table-striped dataTable" id="example1">
                        ...
                        <tr>
                            ...
                            <td><a href="#editKategori<?= $ktg->id_kategori;?>" data-toggle='modal' class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                            <a data-toggle="modal" href="#deleteKategori<?=$ktg->id_kategori;?>" data-url="" class="btn btn-danger confirm_delete"  title="Hapus" class="btn btn-danger"  data-toggle="tooltip" data-placement="left" title="Hapus Pegawai"><i class="fa fa-trash"></i> Hapus</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class='form-group'>
                    ...
                    <div class='col-lg-9'>
                        <input type='hidden' name="i_kategori" class='form-control' id='id_kategoris'
                               value='<?php echo $rows->id_kategori; ?>'>
                        <input type='text' name="nama_kategori" class='form-control' id='nama_kategoris'
            ...
            <div class="modal-body">
                ...
                <div class='form-group'>
                    ...
                    <div class='col-lg-8'>
                        ...
                        <input type='text' name="nama_kategori" required class='form-control' id='nama_kategoris'
