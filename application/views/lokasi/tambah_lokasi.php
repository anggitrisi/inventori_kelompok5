    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                echo form_open_multipart('Lokasi/insert_lokasi', $attributes); ?>

                <div class="form-group">
                    <div class="col-sm-6"><label>Nama Lokasi</label><input class="form-control" name="nama_lokasi" autofocus="" type="text" value="<?= set_value('nama_lokasi') ?>"><?= form_error('nama_lokasi', '<small class="text-danger">', '</small>'); ?>
                    </div>
