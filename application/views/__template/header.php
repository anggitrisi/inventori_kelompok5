...
<head>
    ...
    <title>Inventaris Kelompok 5</title>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    if ($url == $url_1 || $url == $url_2 || $url == $url_3 || $url == $url_4) { ?>
                        <li>
                            <a href="<?= base_url(); ?>dashboard"><i class="icon-home"></i></a><span class="divider-last">&nbsp;</span>
                        </li>
                    ...
                    <?php } else { ?>
                        ...
                        <?php if ($this->session->userdata('child_name')) { ?>
                            ...
                            <li>
                                <a style="color: green; font-weight: bold; font-style: normal" href="<?php echo $this->session->userdata('child_url'); ?>"><?php echo $this->session->userdata('child_name'); ?></a><span class="divider-last">&nbsp;</span>
                            </li>
